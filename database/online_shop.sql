...
--
-- Host: localhost
-- Generation Time: Feb 23, 2015 at 12:04 PM
...
('AADEA001', 'Pendi Setiawan', 'Pondok Ungu Permai', '0123456789', 'sacktiawan@gmail.com'),
('ADEBE001', 'Beverly', 'Rnuzsv lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.', '3105553390', 'bhills_3390@veryrealemail.com'),
('ADEBE002', 'Beverly', 'Jgoisk lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.', '3105551853', 'bhills_1853@veryrealemail.com'),
('ADEBE003', 'Beverly', 'Ezlfhy lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.', '3105554570', 'bhills_4570@veryrealemail.com'),
('BFBAD001', 'sasasasas', 'Sbjbld lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.', '3105553460', 'bhills_3460@veryrealemail.com');
...
INSERT INTO `orders` (`id_order`, `id_cus`) VALUES
('DAFBA001', 'ADEBE001'),
('DAFBA002', 'ADEBE002'),
('DAFBA003', 'BFBAD001'),
('DAFBA004', 'AADEA001'),
...
INSERT INTO `orders_temp` (`id_order_temp`, `id_product`, `id_session`, `quantity`) VALUES
('BDFBD0001', 'ACFAF001', '20150219173242', 1);
...
('ASCBA001', 'Asus', 'A450CA- WX106D WX107D WX219D i3-3217U-DOS-Gray', 4869900, 'Intel Core i3-3217U, VGA Intel HD Graphics 3000, 14" Resolution up to 1366 x 768, 2GB DDR3, 500GB HDD, DVD RW, WiFi, Camera, DOS.', 2, '../image/product/asus/asus-a450ca-wx107d-wx219d-i3-3217u-or-2gb-or-500gb-dos-gray-1.png', 3, 2),
...
('HPCCE001', 'HP Compaq', '14-d010AU E1-2100-DOS-Black', 3407300, 'AMD Dual Core E1-2100, AMD Radeon HD 8210G (Shared), 14" Resolution up to 1366x768px, 2GB DDR3, 320GB HDD, DVD±RW, NIC, WiFi, Non OS.', 0, '../image/product/hp/hp-14-d010au-e1-2100-or-2gb-or-320gb-dos-black-1.png', 5, 2),
...
INSERT INTO `transaksi` (`id`, `id_order`, `id_product`, `quantity`) VALUES
(1, 'DAFBA001', 'ACFAF001', '1'),
(2, 'DAFBA002', 'HPCCE001', '1'),
(3, 'DAFBA003', 'LEFEF001', '1'),
(4, 'DAFBA004', 'ACFAF001', '1'),
(5, 'DAFBA004', 'LEFEF001', '2'),
(6, 'DAFBA005', 'ACFAF001', '1'),
(7, 'DAFBA006', 'ACFAF001', '1');
