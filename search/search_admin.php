				...
				<?php while ($r=mysql_fetch_array($sql)) : ?>
					...
					<tr>
						<td class="padding-left" width="128px">
							...
							<?php else : ?>
								<a href="../product/detail.php?id_product=<?php echo $r[0] ?>"><img class="scale" src="<?php echo 'http://'.$_SERVER['HTTP_HOST'].'/online_shop/aplikasi/image/no-image.jpg' ?>" width="120px" height="120px"></a>
							<?php endif ?>
						</td>
