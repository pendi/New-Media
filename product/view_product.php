				...
				while ($data = mysql_fetch_array($tampil)) { ?>					
						<tr class="hover">
							...
							<td align='center'>
								...
								<a href="delete.php?id_product=<?php echo $data[0]; ?>"><img title="Hapus" src="<?php echo 'http://'.$_SERVER['HTTP_HOST'].'/new_media/aplikasi/image/delete.png' ?>" width = "15%"></a> &nbsp;
								<?php if($data[8]==1): ?>
								...
								<?php else: ?>
									<a href="publish.php?id_product=<?php echo $data[0]; ?>"><img title="Not Publish" src="<?php echo 'http://'.$_SERVER['HTTP_HOST'].'/new_media/aplikasi/image/publish.png' ?>" width = "17%"></a>
								<?php endif ?>
							</td>
						</tr>					 
					<?php
